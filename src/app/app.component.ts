...
import { peopleOutline, peopleSharp, listOutline, listSharp, barChartOutline, barChartSharp, exitOutline, exitSharp} from 'ionicons/icons';
...
export class AppComponent implements OnInit {
  ...
  constructor() {
    addIcons({ peopleOutline, peopleSharp, listOutline, listSharp, barChartOutline, barChartSharp, exitOutline, exitSharp});
  }
  ...
  ngOnInit(): void {
    ...
    this.appPages =  [
      ...
      { title: 'Registrar', url: '/registro', icon: 'bar-chart' , visible: true},
